            ...
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-2">
                  ...
                  specializing in Python with a 5-star rating on HackerRank. Proficient in Java, C++,
                  and the MERN stack, I bring hands-on project experience in building dynamic web applications.
                </p>
              </div>
